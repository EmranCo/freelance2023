...
public class Afterstart extends AppCompatActivity {
    ...
    public void printBoard() {
        ...
        if (tracker[0][0] == 1)
            q1.setImageResource(R.drawable.x); //if ax=1 means player1=x or if zero=1 means player2=x
        if (tracker[0][0] == 10)
            q1.setImageResource(R.drawable.oo);//if ax=10 means player1=O or if zero=10 means player2=O
