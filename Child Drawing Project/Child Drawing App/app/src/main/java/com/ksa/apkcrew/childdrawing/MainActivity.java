package com.ksa.apkcrew.childdrawing;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button contactBtn = (Button) findViewById(R.id.button);
...
//    }
    ...
    private void openContactPage(View view) {
        view.startAnimation(slideUD);
        paintView.drawingChanging = true;
        final Dialog newDialog = new Dialog(context);
        newDialog.setContentView(R.layout.activity_contact_us);
        newDialog.getWindow().getAttributes().windowAnimations = R.style.CustomDialogAnimation;
        newDialog.show();
    }
