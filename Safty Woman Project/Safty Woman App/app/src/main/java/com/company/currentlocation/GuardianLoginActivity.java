...
public class GuardianLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_guardianOTPSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                userLoginNumber = et_guardianNumberLogin.getText().toString();
    ...
    private void verifyCode(String code) {
        ...
        try {
            ...
            Toast.makeText(GuardianLoginActivity.this, ex.getMessage(), Toast.LENGTH_LONG).show();
        }
    }
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            GuardianInfo guardianInfo = new GuardianInfo(et_guardianName.getText().toString(),et_guardianNumberLogin.getText().toString());
                            databaseReference.child("Guardians").setValue(guardianInfo);
                            databaseReference.child("Guardians").child("user-info").setValue(et_userPhoneNumber.getText().toString());
    ...
    void compare(){
        ...
        databaseReference.child("Users").child( et_userPhoneNumber.getText().toString()).child("GuardianInfo").child("guardianPhone1").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(cGuardianNumber.equals(userLoginNumber)){
                    ...
                    i.putExtra("userNumber", et_userPhoneNumber.getText().toString());
                    startActivity(i);
